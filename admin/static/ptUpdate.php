...
if (isset($_POST['btnUpdate']))
{
    ...
    $status=$_POST['status'];
        ...
        $query="UPDATE product_type SET productTypeName = '$name', status = '$status'
                WHERE productTypeCode = $ID";
        $result=mysqli_query($connect, $query);
 
        if ($result) {
            echo "<script>window.alert('Your product type has been successfully updated!')</script>";
      ...
      $select = "SELECT * FROM product_type WHERE productTypeCode='$ID'";
                        ...
                        <div class="card">
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                        <div class="row mb-3">
											...
											<input class="form-control form-control-lg" type="text" name="productTypeName" placeholder="Enter product-type" value="<?php echo $arr['productTypeName']; ?>"/>
                                            </div>
                                            <div class="col-6">
